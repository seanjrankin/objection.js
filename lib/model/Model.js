...
class Model {
  ...
  $loadRelated(relationExpression, modifiers, transaction) {
    deprecate('$loadRelated is deprected and will be removed in 3.0. Use $fetchGraph instead');
    return this.$fetchGraph(relationExpression, { transaction }).modifiers(modifiers);
  }
  ...
  static loadRelated(models, expression, modifiers, transaction) {
    deprecate('loadRelated is deprected and will be removed in 3.0. Use fetchGraph instead');
    return this.fetchGraph(models, expression, { transaction }).modifiers(modifiers);
  }
